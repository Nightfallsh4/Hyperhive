...
import "@thirdweb/extension/Staking20.sol";
import "@thirdweb/eip/interface/IERC20.sol";
import "@thirdweb/eip/interface/IERC20Metadata.sol";
...
contract Staking is Staking20 {
    ...
    constructor(
        ...
        _setStakingCondition(uint80(_timeUnit), _rewardRatioNumerator, _rewardRatioDenominator);
    ...
    function getRewardTokenBalance() external view override returns (uint256 _rewardsAvailableInContract) {
        _rewardsAvailableInContract = IERC20(rewardToken).balanceOf(address(this));
    }
